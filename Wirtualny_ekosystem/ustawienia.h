...
public:
    ...
    bool poprawnySeprtor(char znak) const
    {
...
private:
    UstawieniaSymulaji(){}
    UstawieniaSymulaji(UstawieniaSymulaji&);

public:
    static UstawieniaSymulaji & pobierzUstawienia(){
        static UstawieniaSymulaji ustawienia;
        return ustawienia;
    }
};
