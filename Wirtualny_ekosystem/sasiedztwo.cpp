...
void Sasiedztwo::zmienIndekdyWgPolozenia(Polozenie polozenie, long &wiersz, long &kolumna)
{
...
void Sasiedztwo::zmienIndekdyWgPolozenia(Polozenie polozenie, unsigned int &wiersz, unsigned int &kolumna){
    long w = static_cast<long>(wiersz);
    long k = static_cast<long>(kolumna);

    zmienIndekdyWgPolozenia(polozenie,w,k);
